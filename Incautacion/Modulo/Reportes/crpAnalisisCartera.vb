...
Public Class crpAnalisisCartera
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Incautacion.Modulo.crpAnalisisCartera.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpAnalisisCartera
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpAnalisisCartera = New crpAnalisisCartera()
        rpt.Site = Me.Site
        Return rpt
    End Function
