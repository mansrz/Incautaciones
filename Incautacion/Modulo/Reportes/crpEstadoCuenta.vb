...
Public Class crpEstadoCuenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Incautacion.Modulo.crpEstadoCuenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpEstadoCuenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpEstadoCuenta = New crpEstadoCuenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
