...
Partial Class CtlEntidadNatural
    ...
    Me.CtlIdentificacion5 = New Incautacion.Modulo.CtlIdentificacion()
    Me.CtlIdentificacion4 = New Incautacion.Modulo.CtlIdentificacion()
    Me.CtlIdentificacion3 = New Incautacion.Modulo.CtlIdentificacion()
    Me.CtlIdentificacion2 = New Incautacion.Modulo.CtlIdentificacion()
    Me.CtlIdentificacion1 = New Incautacion.Modulo.CtlIdentificacion()
    Me.GroupBox3 = New Infoware.Controles.Base.TaskBoxStd()
    Me.CtlEmail2 = New Incautacion.Modulo.CtlEmail()
    Me.CtlEmail1 = New Incautacion.Modulo.CtlEmail()
    Me.TaskBoxStd2 = New Infoware.Controles.Base.TaskBoxStd()
    Me.CtlTelefono1 = New Incautacion.Modulo.CtlTelefono()
    Me.CtlTelefono2 = New Incautacion.Modulo.CtlTelefono()
    Me.CtlTelefono3 = New Incautacion.Modulo.CtlTelefono()
    Me.TaskBoxStd1 = New Infoware.Controles.Base.TaskBoxStd()
    Me.CtlDireccion1 = New Incautacion.Modulo.CtlDireccion()
    Me.TableLayoutPanel3 = New System.Windows.Forms.TableLayoutPanel()
    Me.ComboBoxSexo = New Incautacion.Modulo.ComboBoxParametroDet()
    Me.Entnat_ApellidopaternoTextBox = New Infoware.Controles.Base.TextBoxStd()
    Me.ComboBoxEstadoCivil = New Incautacion.Modulo.ComboBoxParametroDet()
    ...
    '
    Me.EntidadNaturalBindingSource.DataSource = GetType(Incautacion.Reglas.EntidadNatural)
    '
    'grpsri
    '
    ...
    Me.CtlIdentificacion5.TipoIdentificacion = Incautacion.Reglas.Enumerados.enumTipoIdentificacion.RUC
    Me.CtlIdentificacion5.TipoLugar = Incautacion.Reglas.Enumerados.EnumTipoLugar.Sucursal
    '
    'CtlIdentificacion4
    '
    ...
    Me.CtlIdentificacion4.TipoIdentificacion = Incautacion.Reglas.Enumerados.enumTipoIdentificacion.RUC
    Me.CtlIdentificacion4.TipoLugar = Incautacion.Reglas.Enumerados.EnumTipoLugar.Sucursal
    '
    'CtlIdentificacion3
    '
    ...
    Me.CtlIdentificacion3.TipoIdentificacion = Incautacion.Reglas.Enumerados.enumTipoIdentificacion.RUC
    Me.CtlIdentificacion3.TipoLugar = Incautacion.Reglas.Enumerados.EnumTipoLugar.Sucursal
    '
    'CtlIdentificacion2
    '
    ...
    Me.CtlIdentificacion2.TipoIdentificacion = Incautacion.Reglas.Enumerados.enumTipoIdentificacion.RUC
    Me.CtlIdentificacion2.TipoLugar = Incautacion.Reglas.Enumerados.EnumTipoLugar.Sucursal
    '
    'CtlIdentificacion1
    '
    ...
    Me.CtlIdentificacion1.TipoIdentificacion = Incautacion.Reglas.Enumerados.enumTipoIdentificacion.RUC
    Me.CtlIdentificacion1.TipoLugar = Incautacion.Reglas.Enumerados.EnumTipoLugar.Sucursal
    '
    'GroupBox3
    '
    ...
    Me.CtlEmail2.TipoEmail = Incautacion.Reglas.Enumerados.enumTipoEmail.Trabajo
    '
    'CtlEmail1
    '
    ...
    Me.CtlEmail1.TipoEmail = Incautacion.Reglas.Enumerados.enumTipoEmail.Trabajo
    '
    'TaskBoxStd2
    '
    ...
    Me.CtlTelefono1.TipoTelefono = Incautacion.Reglas.Enumerados.enumTipoTelefono.Trabajo
    '
    'CtlTelefono2
    '
    ...
    Me.CtlTelefono2.TipoTelefono = Incautacion.Reglas.Enumerados.enumTipoTelefono.Trabajo
    '
    'CtlTelefono3
    '
    ...
    Me.CtlTelefono3.TipoTelefono = Incautacion.Reglas.Enumerados.enumTipoTelefono.Trabajo
    '
    'TaskBoxStd1
    '
    ...
    Me.ComboBoxSexo.Parametro = Incautacion.Reglas.Enumerados.EnumParametros.TipoEntidad
    ...
    Me.ComboBoxEstadoCivil.Parametro = Incautacion.Reglas.Enumerados.EnumParametros.TipoEntidad
