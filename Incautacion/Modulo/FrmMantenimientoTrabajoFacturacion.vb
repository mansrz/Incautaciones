...
Public Class FrmMantenimientoTrabajoFacturacion
  '#Region "IOpcion"
...
#Region "Parametros"
  ...
  Sub llenar_datos()
    ...
    If mTrabajo IsNot Nothing Then
      ...
      If mTrabajo.UltimoTrabajoLog IsNot Nothing OrElse mTrabajo.UltimoTrabajoLog.Pardet_AccionTrabajo = Enumerados.enumEstadoSobre.LiberadoImprenta Then
        ...
        'End If
        If mTrabajo.UltimoTrabajoLog.Pardet_AccionTrabajo = Enumerados.enumEstadoSobre.LiberadoImprenta Then
          Dim _trabajolog As New TrabajoLog(mTrabajo, True)
          _trabajolog.PardetAccionTrabajo = New WWTSParametroDet(Sistema.OperadorDatos, Enumerados.EnumParametros.EstadoSobre, Enumerados.enumEstadoSobre.TomadoFacturacion)
...
#Region "Cerrar y Cancelar"
  Private Sub FrmMantenimientoTrabajoFacturacion_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    Cancelar_Nuevo()
  End Sub
...
#Region "Trabajos eventos"
  Private Sub FrmMantenimientoTrabajoFacturacion_CrearNuevo(ByVal sender As Object, ByVal e As System.ComponentModel.AddingNewEventArgs) Handles Me.CrearNuevo
    Dim _Trabajo As Trabajo = New Trabajo(mSucursal, True)
    e.NewObject = _Trabajo
  End Sub

  Private Sub FrmMantenimientoTrabajoFacturacion_Actualizar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Actualizar
    llenar_datos()
  End Sub
#End Region

#Region "Guardar y Eliminar"
  Private Sub FrmMantenimientoTrabajoFacturacion_Guardar(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Guardar
  ...
  Private Function Guardar_datos() As Boolean
    Try
      ...
      If mTrabajoxMovimientoInventarioVenta.Guardar(Me.CtlBloqueo1.Bloqueado) Then
        ...
        Dim _trabajolog As New TrabajoLog(mTrabajo, True)
        Select mTrabajo.UltimoTrabajoLog.Pardet_AccionTrabajo
          Case Enumerados.enumEstadoSobre.LiberadoImprenta, Enumerados.enumEstadoSobre.TomadoFacturacion, Enumerados.enumEstadoSobre.LiberadoFacturacion
            _trabajolog.PardetAccionTrabajo = New WWTSParametroDet(Sistema.OperadorDatos, Enumerados.EnumParametros.EstadoSobre, Enumerados.enumEstadoSobre.LiberadoFacturacion)
          Case Else
            _trabajolog.PardetAccionTrabajo = New WWTSParametroDet(Sistema.OperadorDatos, Enumerados.EnumParametros.EstadoSobre, Enumerados.enumEstadoSobre.CasoAperturado)
        End Select
  ...
  Private Sub FrmMantenimientoTrabajoFacturacion_Eliminar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Eliminar
...
#Region "Mover"
  Private Sub FrmMantenimientoTrabajoFacturacion_Primero(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Primero
    e.Cancel = Cancelar_Nuevo()
  End Sub

  Private Sub FrmMantenimientoTrabajoFacturacion_Siguiente(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Siguiente
    e.Cancel = Cancelar_Nuevo()
  End Sub

  Private Sub FrmMantenimientoTrabajoFacturacion_Ultimo(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Ultimo
    e.Cancel = Cancelar_Nuevo()
  End Sub

  Private Sub FrmMantenimientoTrabajoFacturacion_Anterior(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles Me.Anterior
    e.Cancel = Cancelar_Nuevo()
  End Sub
#End Region
...
#End Region
  ...
  Private Sub btncancelar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncancelar.Click
    ...
    Dim _trabajolog As New TrabajoLog(mTrabajo, True)
    Select Case mTrabajo.UltimoTrabajoLog.Pardet_AccionTrabajo
      Case Enumerados.enumEstadoSobre.TomadoFacturacion, Enumerados.enumEstadoSobre.LiberadoFacturacion
        _trabajolog.PardetAccionTrabajo = New WWTSParametroDet(Sistema.OperadorDatos, Enumerados.EnumParametros.EstadoSobre, Enumerados.enumEstadoSobre.RechazadoFacturacion)
      Case Else
    ...
    If _trabajolog.Guardar() Then
      Auditoria.Registrar_Auditoria(Restriccion, Enumerados.enumTipoAccion.Modificacion, "Devolvió trabajo a Imprenta")
      Me.Close()
    End If
  End Sub
