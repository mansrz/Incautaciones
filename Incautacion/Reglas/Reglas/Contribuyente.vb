...
Public Class Contribuyente
    ...
    Const _Procedimiento As String = "proc_Contribuyente"
    ...
    Public Overridable Sub MapearDataRowaObjeto(ByVal Fila As DataRow)
        ...
        Contri_Visible = CType(Fila("Contri_Visible"), Boolean)
        mEntidad = Nothing
    ...
    Public Overridable Function Guardar() As Boolean
        ...
        If bReturn Then
            ...
            OperadorDatos.AgregarParametro("@Entida_Codigo", Entida_Codigo)
            OperadorDatos.AgregarParametro("@Contri_Visible", Contri_Visible)
...
Public Class ContribuyenteList
    Inherits System.ComponentModel.BindingList(Of Contribuyente)

    Public Shared Function ObtenerLista(ByVal _OperadorDatos As OperadorDatos, Optional ByVal _filtro As String = "") As ContribuyenteList
        Dim oResult As ContribuyenteList = New ContribuyenteList
        Dim bReturn As Boolean
        Dim ds As DataTable = Nothing
        With _OperadorDatos
            .AgregarParametro("@Accion", "F")
            .AgregarParametro("@filtro", _filtro)
            .Procedimiento = "proc_Contribuyente"
            bReturn = .Ejecutar(ds)
            .LimpiarParametros()
        End With
        If bReturn AndAlso Not ds Is Nothing AndAlso ds.Rows.Count > 0 Then
            For Each _dr As DataRow In ds.Rows
                Dim _fila As New Contribuyente(_OperadorDatos, False)
