...
Public Class Trabajo
  ...
  Public ReadOnly Property HoraApertura As String
    Get
      ...
      For Each _tlog As TrabajoLog In TrabajoLogList.ObtenerLista(Me)
        If _tlog.Pardet_AccionTrabajo = Enumerados.enumEstadoSobre.CasoAperturado Then
    ...
    Get
      ...
      For Each _tlog As TrabajoLog In TrabajoLogList.ObtenerLista(Me)
        Select Case _tlog.Pardet_AccionTrabajo
          Case Enumerados.enumEstadoSobre.TomadoProforma
            _fecha = _tlog.TraLog_FechaHora
  ...
  Public ReadOnly Property HoraImprenta As String
    Get
      ...
      For Each _tlog As TrabajoLog In TrabajoLogList.ObtenerLista(Me)
        Select Case _tlog.Pardet_AccionTrabajo
          Case Enumerados.enumEstadoSobre.TomadoQuirofano
            _fecha = _tlog.TraLog_FechaHora
  ...
  Public ReadOnly Property TiempoEditorMinutos As Integer
    Get
      ...
      For Each _tlog As TrabajoLog In TrabajoLogList.ObtenerLista(Me)
        If _tlog.Pardet_AccionTrabajo = Enumerados.enumEstadoSobre.TomadoProforma Then
          _fechaEditor = _tlog.TraLog_FechaHora
        End If
        If _tlog.Pardet_AccionTrabajo = Enumerados.enumEstadoSobre.TomadoQuirofano Then
